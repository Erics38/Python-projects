@echo off
echo === SECURITY GROUPS CLEANUP ===
echo.
echo WARNING: This will delete security groups. Make sure all resources are deleted first!
echo.
pause

echo Deleting guestbook security groups...
echo.

REM Delete security groups (order matters due to dependencies)
...
echo.
echo Next: Run cleanup-vpcs.bat to delete unused VPCs